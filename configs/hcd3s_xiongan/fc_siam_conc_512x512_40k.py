# fc_siam_conc - 继承官方 LEVIR config, 仅把数据集换为 HCD-3S(train)->雄安(val) 512 跨区域
_base_ = ['../fcsn/fc_siam_conc_256x256_40k_levircd.py']
...
# 注: FC 系列在本异源极不平衡设置下从头训练塌缩为全背景(纯CE/OHEM/CE+Dice/Focal 均如此, 连域内都0),
#     论文按 collapsed 处理、不报退化分(见 gold-article/rebuttal/baseline_crossregion_xiongan.md)。
